...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
    ...
    return (
        <div className="product-card p-4 rounded-lg transition-all cursor-pointer duration-300 w-[300px] hover:scale-105">
            <div className="flex justify-center items-center min-h-[300px]">
            <img onClick={handleViewMore} src={product.img || "/LogoOrthodontika1.png"} alt={product.nombre} className="w-full max-h-[300px] p-5 object-contain" />
            </div>
